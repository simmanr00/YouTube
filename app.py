...
api_version = "v3"
api_Key="AIzaSyDvjUQdyL-41hn9GrMJSBa1hdfPr7Yj9HU"
...
st.set_page_config(page_title='YouTube Data Harvesting and Warehousing',
                    ...
                    menu_items={'About': '''Make-up by Simman
                                Contact_e-mail: narasimman1026@gmail.com'''})
# Function to encode a local image to base64 format
...
img_file = 'pexels-pixabay-235985.jpg'  # Replace with your image path
img_data = get_base64_of_bin_file(img_file)

# Inject the CSS to set the background image
st.markdown(
    f"""
    <style>
    .stApp {{
...
with st.sidebar:
    selected =option_menu("Main Menu",
                        ...
                        icons=["house","cloud-upload","database", "filetype-sql", "bar-chart"],
                        menu_icon="cast",
                        orientation="vertical")

# Setting up the option "Home" in streamlit page
if selected == "Home":
    st.title(':red[You]Tube :black[Data Harvesting & Warehousing using SQL]')
    st.subheader(':green[Domain :] Social Media')
    ...
    st.subheader(':green[Skill Take Away :]')
    st.markdown(''' Python scripting,Data Collection,API integration,Data Management using SQL,Streamlit''')
    st.subheader(':blue[About :]')
    st.markdown('''Hello! I'm Narasimman, a B.Sc graduate with a keen interest in data science and analytics.
                ...
                where I explored the vast real of YouTube data to extract meaningful insights.
    ...
    st.markdown('#### GitHub: https://github.com/NsN1008')
    st.markdown('#### Email : narasimmanr008@gmail.com')
